    ...
    <div class="widget-box">
        <div class="widget-header">
            ...
            <div class="widget-toolbar">
                <a href="{{ route('admin.subcategories.create') }}" class="btn btn-xs btn-primary">
                                            ...
                                            <tr>
                                                ...
                                                <td class="hidden-480">
                                                    <div class="action-buttons">
                                                        ...
                                                        <a class="green" href="{{ route('admin.subcategories.edit', $category-> id) }}">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                        </a>

                                                        <a class="red" href="{{ route('admin.subcategories.delete', $category-> id) }}">
