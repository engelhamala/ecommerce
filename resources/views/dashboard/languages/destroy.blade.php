...
@section('content')
    <div class="widget-box">
        ...
        <form class="form-horizontal" role="form" method="post" action="{{ route('dashboard.delete-languages' ,  $lang->id)}}"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $lang->name}}" name="name" id="name" class="form-control"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $lang->abbr}}" name="abbr" id="abbr" class="form-control"
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary" name="save">
                    <i class="la la-check-square-o"></i> حذف
                </button>
            </div>
        </form>
    </div>
