                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post"
                                            action="{{ route('dashboard.update-maincategories', $maincategory->id) }}"
                                            ...
                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img src="{{$maincategory ->photo}}rounded-circle height-150" alt="صورة القسم">
                                                </div>
                                            </div>
                                ...
                                @isset($maincategory->categories)
                                    @foreach ($maincategory->categories as $index => $translation)
                                        <div role="tabpanel"
                                            ...
                                            <form class="form"
                                                action="{{ route('dashboard.update-maincategories', $translation->id) }}"
