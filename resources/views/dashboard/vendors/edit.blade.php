                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form-horizontal" method="post" action="{{ route('dashboard.update-vendor', $vendor->id) }}" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="form-group">
                                            <div class="text-center">
                                                <img src="{{$vendor ->logo}}rounded-circle width-200 height-250" alt="صورة القسم">
                                            </div>
                                        </div>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane fade in active">
                                                <div class="form-group">
                                                    <label for="logo"> لوغو المتجر </label>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <input type="text" name="name" id="name" value="{{ $vendor -> name }}" placeholder="" class="form-control" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <input type="phone" name="phone" id="phone" value="{{ $vendor -> phone }}" placeholder="" class="form-control" />
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label no-padding-right" for="active">
                                                                الحالة
                                                            </label>
                                                            <div class="col-sm-7">
                                                                <input name="active" id="id-button-borders active" checked="" type="checkbox" value="1"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <input type="text" name="address" id="pac-input address" value="{{ $vendor -> address }}" placeholder="" class="form-control" />
                                                    ...
                                                    <div class="col-xs-6">
                                                        <div class="form-group">
                                                            <label class="col-sm-3 control-label no-padding-right" for="category_id"> اختر القسم </label>
                                                            <div class="col-sm-7">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <input type="email" name="email" id="email" value="{{ $vendor -> email }}" placeholder="" class="form-control" />
